...
## Communication (MUST)
- Answer first, then request approval if needed. This applies before any interaction flow begins; once a valid choice is received, follow AGENT.interaction.md EXECUTION SILENCE rules.
