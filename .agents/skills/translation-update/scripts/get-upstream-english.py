...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Download upstream english.xml for translation-update skill.")
    parser.add_argument(
        "-UpstreamEnglishUrl",
...
def main() -> int:
            ...
            headers=(
                {
                    ...
                    "User-Agent": "bg3-dnd55e-translation-update-skill/1.0",
                }
                if args.force
                else {"User-Agent": "bg3-dnd55e-translation-update-skill/1.0"}
            ),
        )
    ...
    print(f"[translation-update:get-upstream] Saved upstream english.xml to '{output_path}'.")
    print(
        "[translation-update:get-upstream] Entries: "
