    ...
    try:
        ...
        if is_up_to_date:
            ...
            md_lines.extend(
                [
                    "## Skill workflow",
                    "1. Refresh upstream cache: ``python .agents/skills/translation-update/scripts/get-upstream-english.py``",
                    "2. Refresh diff reports: ``python .agents/skills/translation-update/scripts/compare-translation.py``",
                    "3. Fill translated texts in ``build/translation-diff/candidates.json``",
                    "4. Apply prepared edits: ``python .agents/skills/translation-update/scripts/apply-translation-edits.py --edits-path build/translation-diff/candidates.json``",
                ]
            )
